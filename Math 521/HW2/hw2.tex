...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \end{align*}
        Because $X,Y$ are i.i.d., $\E[f(X)g(Y)] = \E[f(X)]\E[g(Y)] = \E[f(X)]\E[g(X)]$, and $\E[f(Y)g(Y)] = \E[f(X)g(X)]$. Adding the two negative terms to both sides yields the desired inequality.
