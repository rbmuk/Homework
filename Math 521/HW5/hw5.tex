...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \end{align*}
        Again by the independence, we know that 
        \begin{align*}
            \P(\sum_{m+1}^{m+n} X_i \leq a) = \P(\sum_{m+1}^{m+n} X_i \leq a \mid N(t) - N(s) = n, N(s) = m)
        \end{align*} and 
        \begin{align*}
            \P(\sum_{1}^{m} X_i \leq b) = \P(\sum_{1}^{m} X_i \leq b \mid N(t) - N(s) = n, N(s) = m)
        \end{align*} 
        Thus we get that:
        \begin{align*}
            \sum_{m,n} \P(\sum_{m+1}^{m+n} X_i \leq a, \sum_{1}^{m} X_i \leq b) &\P(N(s) = m, N(t) - N(s) = n) 
            \\&= \sum_{m,n} \P(\sum_{N(s)+1}^{N(t)} X_i \leq a, N(t) - N(s) = n, N(s)=m) \cdot
        \end{align*}
