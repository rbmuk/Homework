...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            l_a = f(a) - \sup_{x < a} f(x) \quad \text{and} \quad r_a = \inf_{x > a} f(x) - f(a)
        \end{align*}
        ...
        We shall show that there is an $\ve > 0$ so that uncountably many of the $j_a$ are greater than $\ve$. Otherwise, the set of such $j_a$'s is a countable union of countable sets, namely the union of those that are greater than $1/n$ for each $n$, a contradiction. 
        ...
        \item I claim that, if $\mathscr B$ is any $\sigma$-algebra, then
        \begin{align*}
        ...
        Thus,
        \begin{align*}
            \mathscr G = \sigma(\mathscr A) \subset \SET{B : X^{-1}(B) \in \mathscr \sigma(X^{-1}(\mathscr A))}
        \end{align*}
        Then,
        \begin{align*}
            \sigma(X) = X^{-1}(\mathscr G) \subset \sigma(X^{-1}(\mathscr A))
        \end{align*}
        The reverse is easier, clearly $X^{-1}(\mathscr A) \subset X^{-1}(\mathscr G)$. Thus $\sigma(X^{-1}(\mathscr A)) \subset X^{-1}(\mathscr G)$ and we are done.
